...
import './../_components/css/About.css';
  ...
  return ( 
    <div className="about">
      <div className="aboutus">
        <h2>About Us</h2>
        <p>We are a <strong>Moblie Auto Detail</strong> company, that provides
          ...
          have your vehicle detailed. The people at norfolkautodetail.com know that
      ...
      <p>We come to your location, ready to provide
        ...
        by NAD, and guanteed to be amoung the best. Try them out
        for yourself, or call NAD and we will be glad to accommodate
