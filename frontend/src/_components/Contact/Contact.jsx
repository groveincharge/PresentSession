      ...
      event.preventDefault();
       ...
       fetch('http://localhost:7000/addContact',{
                                    ...
                                    headers: {
                                       ...
                                       'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6IndkYXNlbnRAYW9sLmNvbSIsInVzZXJJZCI6IjVkYTllZGMxNzdmOTA1MzljYzNmZDgwZiIsImlhdCI6MTU3MTkyNTI2NCwiZXhwIjoxNTcxOTI4ODY0fQ.eSrbT2EioKuB6TMw5KWol8q56YzhpFwfT47eHBQCrCE'
                                        },
